          ...
          <Card className="rounded-sm">
            ...
            <CardContent>
              <div className="max-w-[90ch]">
                ...
                <p className="mb-2">
                  This challenge follows the book Crafting Interpreters by
                  Robert Nystrom.
                </p>
                <p className="mb-2">
                  In this challenge you'll build an interpreter for Lox, a
                  simple scripting language. Along the way, you'll learn about
